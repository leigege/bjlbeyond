...
<div id="mainDiv">
	<div id="topDiv">
	<div id="tmenu"><ul>
	<li ><a href="__APP__/Index/index">后台首页</a></li>
	<li ><a href="/bjl/index.php/Index/index">前台首页</a></li>
	 <li ><a href="__APP__/Index/dologout">退出</a></li>
	...
	<li ><a href="__APP__/Index/message">信息管理</a></li>
	<li ><a href="__APP__/Index/user">用户管理</a></li>
	<li ><a href="__APP__/Index/dayi">在线答疑</a></li>
	<li ><a href="__APP__/Index/liuyan">管理员留言</a></li>
	</ul>
	</div>
	<div id="right"> 
	
	
	<table  class="software" border="1" cellpadding="0" cellspacing="0" width=700 height=30>
	...
	<td>删除软件</td>
	 ...
	 <td ><a href="/bjl/admin.php/Resourse/delete/id/<?php echo ($vo["id"]); ?>">删除 </a></td>
