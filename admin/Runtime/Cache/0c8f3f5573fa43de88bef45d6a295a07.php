...
<div id="mainDiv">
   ...
   <table  class="user" border="1" cellpadding="0" cellspacing="0" width=700 height=30>
	...
	<td>删除用户</td>
	 ...
	 <td ><?php echo ($vo["zy"]); ?> </td>
	 <td ><?php echo ($vo["email"]); ?> </td>
	 <td ><a href="/bjl/admin.php/Index/delete/id/<?php echo ($vo["id"]); ?>">删除 </a></td>
